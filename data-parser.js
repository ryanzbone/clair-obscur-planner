// This script extracts Picto data from data.html and converts it to JSON format
...
function displayParsedData(data) {
    ...
    button.textContent = 'Save to JSON';
    ...
    button.onclick = () => saveToJson(data);
    ...
    heading.textContent = 'Parsed Picto Data';
    heading.style.marginBottom = '20px';
    
    // Add a description
    const description = document.createElement('p');
    description.textContent = `Successfully parsed ${data.length} Pictos from the data.html file. You can review the data below and save it as a JSON file.`;
